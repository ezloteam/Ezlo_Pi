...
{
    bool validity[FINGERPRINT_MAX_CAPACITY_LIMIT + 1]; /* status of each ID [ 1 ~ 'FINGERPRINT_MAX_CAPACITY_LIMIT'] */
    ...
    TaskHandle_t notifyHandler;                        /* Notify Handler to invoke Operation Modes */
...
//------------------------------------------------------------------------------------------------------------------
// FUNCTIONS for Fingerprint Library
//------------------------------------------------------------------------------------------------------------------
#if 0
