...
int sensor_0057_flame_detector_v3(e_ezlopi_actions_t action, l_ezlopi_item_t *item, void *arg, void *user_arg)
{
    int ret = 0;
    switch (action)
    {
...
static int __0057_prepare(void *arg)
{
    ...
    if (device_prep_arg && (NULL != device_prep_arg->cjson_device))
    {
        ...
        if (flame_device_digi)
        {
            ...
            l_ezlopi_item_t *flame_item_digi = ezlopi_device_add_item_to_device(flame_device_digi, sensor_0057_flame_detector_v3);
            if (flame_item_digi)
            {
        ...
        if (flame_device_adc)
        {
            ...
            l_ezlopi_item_t *flame_item_adc = ezlopi_device_add_item_to_device(flame_device_adc, sensor_0057_flame_detector_v3);
            if (flame_item_adc)
            {
