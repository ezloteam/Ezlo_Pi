#ifndef _0052_OTHER_MQ135_NH3_GAS_DETECTOR_H_
#define _0052_OTHER_MQ135_NH3_GAS_DETECTOR_H_
 ...
 *
 * NOTE .1 : Mannually use multimeter and measure : eqv-resistance [mq135_eqv_RL], between [A0_pin vs GND] of 'MQ-4 sensor'
 *
