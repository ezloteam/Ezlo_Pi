#ifndef _0063_SENSOR_OTHER_MQ9_LPG_FLAMEABLE_DETECTOR_H_
#define _0063_SENSOR_OTHER_MQ9_LPG_FLAMEABLE_DETECTOR_H_

#include "ezlopi_actions.h"
#include "ezlopi_devices.h"
/**
 *  NOTE : MQ9_LPG_CH4_gas - module gives (0V - 4.2V) as analog output .
