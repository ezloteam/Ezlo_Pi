...
static const char *ca_certificates =
    "-----BEGIN CERTIFICATE-----\r\n"
...
const char *certificates_get_ca_certificates(void) { return ca_certificates; }
const char *certificates_get_shared_key(void) { return shared_key; }
const char *certificates_get_private_key(void) { return private_key; }
const char *certificates_get_public_key(void) { return public_key; }