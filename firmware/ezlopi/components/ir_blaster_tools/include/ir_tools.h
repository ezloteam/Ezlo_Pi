...
/**
* @brief Creat a LG protocol builder
*
* @param config: configuration of LG builder
* @return
*      Handle of LG builder or NULL
*/
...
/**
* @brief Creat a LG protocol parser
*
* @param config: configuration of LG parser
* @return
*      Handle of LG parser or NULL
*/
