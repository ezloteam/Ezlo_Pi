...
static int __0054_get_item(l_ezlopi_item_t *item, void *arg);
...
static int __0054_prepare(void *arg)
{
    ...
    if (device_prep_arg && (NULL != device_prep_arg->cjson_device))
    {
        ...
        if (flowmeter_device)
        {
            ...
            l_ezlopi_item_t *flowmeter_item = ezlopi_device_add_item_to_device(flowmeter_device, sensor_0054_pwm_flowmeter_v3);
            if (flowmeter_item)
            {
