...
static s_ezlopi_device_properties_t *ezlopi_servo_motor_MG_996R_prepare(cJSON *cjson_device)
{
    ...
    if (ezlopi_servo_motor_MG_996R_properties)
    {
        ...
        ezlopi_servo_motor_MG_996R_properties->ezlopi_cloud.device_id = ezlopi_device_generate_device_id();
        ezlopi_servo_motor_MG_996R_properties->ezlopi_cloud.room_id = ezlopi_device_generate_room_id();
        ezlopi_servo_motor_MG_996R_properties->ezlopi_cloud.item_id = ezlopi_device_generate_item_id();
...
static int ezlopi_servo_motor_MG_996R_set_value(s_ezlopi_device_properties_t *properties, void *arg)
{
    ...
    if (NULL != cjson_params)
    {
        ...
        {
            int target_value = (int)(((value * 17) / 120) + 13);
...
static int ezlopi_servo_motor_MG_996R_get_value_cjson(s_ezlopi_device_properties_t *properties, void *args)
{
    ...
    if (cjson_propertise)
    {
        ...
        int target_duty = (int)(((duty - 13) * 120) / 17);
