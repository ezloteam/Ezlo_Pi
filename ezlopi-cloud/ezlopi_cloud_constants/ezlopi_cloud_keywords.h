...
const static char *ezlopi_device_id_str = "deviceId";
const static char *ezlopi_device_ids_str = "deviceIds";
...
const static char *ezlopi_msg_subclass_str = "msg_subclass";
...
const static char *ezlopi_error_str = "error";
