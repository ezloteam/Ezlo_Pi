...
void print_factory_info_v3(void)
{
    ...
    TRACE_W("LOCAL_KEY [off: 0x%04X, size: 0x%04X]:           %s", ezlopi_factory_info_v3_get_abs_address(EZLOPI_FINFO_REL_OFFSET_LOCAL_KEY, E_EZLOPI_FACTORY_INFO_HUB_DATA), EZLOPI_FINFO_LEN_LOCAL_KEY, local_key ? local_key : "null");
