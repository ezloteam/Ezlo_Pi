...
static void ezlopi_mdns_init_service_context()
{
    ...
    l_ezlopi_mdns_context_t* ezlopi_mdns_service_cntx_device_type = (l_ezlopi_mdns_context_t*)malloc(__FUNCTION__, sizeof(l_ezlopi_mdns_context_t));
    if (ezlopi_mdns_service_cntx_device_type)
    {
        memset(ezlopi_mdns_service_cntx_device_type, 0, sizeof(l_ezlopi_mdns_context_t));
        mdns_txt_item_t* service_cntx_device_type = (mdns_txt_item_t*)malloc(__FUNCTION__, sizeof(mdns_txt_item_t));
    ...
    l_ezlopi_mdns_context_t* ezlopi_mdns_service_cntx_device_id = (l_ezlopi_mdns_context_t*)malloc(__FUNCTION__, sizeof(l_ezlopi_mdns_context_t));

    if (ezlopi_mdns_service_cntx_device_id)
    {
        memset(ezlopi_mdns_service_cntx_device_id, 0, sizeof(l_ezlopi_mdns_context_t));

        mdns_txt_item_t* service_cntx_device_id = (mdns_txt_item_t*)malloc(__FUNCTION__, sizeof(mdns_txt_item_t));
        if (service_cntx_device_id)
        {
            ...
            if (id_val)
            {
                char* id_val_str = (char*)malloc(__FUNCTION__, EZPI_MDNS_SERIAL_SIZE);
                if (id_val_str)
                {
    ...
    l_ezlopi_mdns_context_t* ezlopi_mdns_service_cntx_manufacturer = (l_ezlopi_mdns_context_t*)malloc(__FUNCTION__, sizeof(l_ezlopi_mdns_context_t));
    if (ezlopi_mdns_service_cntx_manufacturer)
    {
        memset(ezlopi_mdns_service_cntx_manufacturer, 0, sizeof(l_ezlopi_mdns_context_t));
        mdns_txt_item_t* service_cntx_manufacturer = (mdns_txt_item_t*)malloc(__FUNCTION__, sizeof(mdns_txt_item_t));
    ...
    l_ezlopi_mdns_context_t* ezlopi_mdns_service_cntx_brand = (l_ezlopi_mdns_context_t*)malloc(__FUNCTION__, sizeof(l_ezlopi_mdns_context_t));
    if (ezlopi_mdns_service_cntx_brand)
    {
        memset(ezlopi_mdns_service_cntx_brand, 0, sizeof(l_ezlopi_mdns_context_t));
        mdns_txt_item_t* service_cntx_brand = (mdns_txt_item_t*)malloc(__FUNCTION__, sizeof(mdns_txt_item_t));
    ...
    l_ezlopi_mdns_context_t* ezlopi_mdns_service_cntx_model = (l_ezlopi_mdns_context_t*)malloc(__FUNCTION__, sizeof(l_ezlopi_mdns_context_t));
    if (ezlopi_mdns_service_cntx_model)
    {
        memset(ezlopi_mdns_service_cntx_model, 0, sizeof(l_ezlopi_mdns_context_t));
        mdns_txt_item_t* service_cntx_model = (mdns_txt_item_t*)malloc(__FUNCTION__, sizeof(mdns_txt_item_t));
    ...
    l_ezlopi_mdns_context_t* ezlopi_mdns_service_cntx_name = (l_ezlopi_mdns_context_t*)malloc(__FUNCTION__, sizeof(l_ezlopi_mdns_context_t));
    if (ezlopi_mdns_service_cntx_name)
    {
        memset(ezlopi_mdns_service_cntx_name, 0, sizeof(l_ezlopi_mdns_context_t));
        mdns_txt_item_t* service_cntx_name = (mdns_txt_item_t*)malloc(__FUNCTION__, sizeof(mdns_txt_item_t));
...
static mdns_txt_item_t* prepare_mdns_item_service_context(int* service_size)
{
    ...
    if (mdns_context_head)
    {
        ...
        *service_size = size;
        mdns_context = (mdns_txt_item_t*)malloc(__FUNCTION__, size * sizeof(mdns_txt_item_t));
        if (mdns_context)
        {
            int i = 0;
