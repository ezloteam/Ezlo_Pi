...
CLOUD_METHOD("hub.modes.disarmed_devices.add", ezlopi_cloud_modes_disarmed_devices_add, ezlopi_cloud_modes_disarmed_devices_added)
CLOUD_METHOD("hub.modes.disarmed_devices.remove", ezlopi_cloud_modes_disarmed_devices_remove, ezlopi_cloud_modes_disarmed_devices_removed)
...
CLOUD_METHOD("hub.modes.cameras_off.add", ezlopi_cloud_modes_cameras_off_add, ezlopi_cloud_modes_cameras_off_added)
CLOUD_METHOD("hub.modes.cameras_off.remove", ezlopi_cloud_modes_cameras_off_remove, ezlopi_cloud_modes_cameras_off_removed)
