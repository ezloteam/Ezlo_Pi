...
CLOUD_METHOD("hub.modes.disarmed_devices.add", EZPI_cloud_modes_disarmed_devices_add, EZPI_cloud_modes_changed)
CLOUD_METHOD("hub.modes.disarmed_devices.remove", EZPI_cloud_modes_disarmed_devices_remove, EZPI_cloud_modes_changed)
...
CLOUD_METHOD("hub.modes.cameras_off.add", EZPI_cloud_modes_cameras_off_add, NULL)
CLOUD_METHOD("hub.modes.cameras_off.remove", EZPI_cloud_modes_cameras_off_remove, NULL)
