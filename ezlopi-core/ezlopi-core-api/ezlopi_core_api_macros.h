...
CLOUD_METHOD("hub.device.group.create", NULL, NULL)//hub.device.group.created
...
CLOUD_METHOD("hub.device.group.get", NULL, NULL)
CLOUD_METHOD("hub.device.groups.list", NULL, NULL)
