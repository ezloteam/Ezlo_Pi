...
CLOUD_METHOD("hub.modes.notifications.set", ezlopi_cloud_modes_notifications_set, ezlopi_cloud_modes_changed_updater)
CLOUD_METHOD("hub.modes.disarmed_default.set", ezlopi_cloud_modes_disarmed_default_set, ezlopi_cloud_modes_changed_updater)
CLOUD_METHOD("hub.modes.disarmed_devices.add", ezlopi_cloud_modes_disarmed_devices_add, ezlopi_cloud_modes_changed_updater)
CLOUD_METHOD("hub.modes.disarmed_devices.remove", ezlopi_cloud_modes_disarmed_devices_remove, ezlopi_cloud_modes_changed_updater)
...
CLOUD_METHOD("hub.modes.protect.buttons.set", ezlopi_cloud_modes_protect_buttons_set, ezlopi_cloud_modes_protect_button_set_updater)
CLOUD_METHOD("hub.modes.protect.devices.add", ezlopi_cloud_modes_protect_devices_add, ezlopi_cloud_modes_protect_device_add_updater)
CLOUD_METHOD("hub.modes.protect.devices.remove", ezlopi_cloud_modes_protect_devices_remove, ezlopi_cloud_modes_protect_device_remove_updater)
