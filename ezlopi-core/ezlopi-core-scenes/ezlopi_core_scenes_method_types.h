...
EZLOPI_SCENE(WHEN_METHOD_AND, "and", ezlopi_scene_when_and, "ezlopi_when_category_function_str")
EZLOPI_SCENE(WHEN_METHOD_NOT, "not", ezlopi_scene_when_not, "ezlopi_when_category_function_str")
EZLOPI_SCENE(WHEN_METHOD_OR, "or", ezlopi_scene_when_or, "ezlopi_when_category_function_str")
EZLOPI_SCENE(WHEN_METHOD_XOR, "xor", ezlopi_scene_when_xor, "ezlopi_when_category_function_str")
EZLOPI_SCENE(WHEN_METHOD_FUNCTION, "function", ezlopi_scene_when_function, "ezlopi_when_category_function_str")
// then
