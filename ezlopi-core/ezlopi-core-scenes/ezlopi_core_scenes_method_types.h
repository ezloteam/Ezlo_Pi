...
EZLOPI_SCENE(WHEN_METHOD_FUNCTION, "function", ezlopi_scene_when_function, NULL)
// then
...
EZLOPI_SCENE(THEN_RESET_LATCH, "resetLatch", ezlopi_scene_then_reset_latch, NULL)
EZLOPI_SCENE(THEN_RESET_SCENE_LATCHES, "resetSceneLatches", ezlopi_scene_then_reset_scene_latches, NULL)
EZLOPI_SCENE(THEN_REBOOT_HUB, "rebootHub", ezlopi_scene_then_reboot_hub, NULL)
EZLOPI_SCENE(THEN_RESET_HUB, "resetHub", ezlopi_scene_then_reset_hub, NULL)
EZLOPI_SCENE(THEN_CLOUD_API, "cloudAPI", ezlopi_scene_then_cloud_api, NULL)
EZLOPI_SCENE(THEN_SET_EXPRESSION, "setExpression", ezlopi_scene_then_set_expression, NULL)
EZLOPI_SCENE(THEN_SET_VARIABLE, "setVariable", ezlopi_scene_then_set_variable, NULL)
EZLOPI_SCENE(THEN_TOGGLE_VALUE, "toggleValue", ezlopi_scene_then_toggle_value, NULL)
//
EZLOPI_SCENE(METHOD_TYPE_MAX, "max", NULL, NULL)
