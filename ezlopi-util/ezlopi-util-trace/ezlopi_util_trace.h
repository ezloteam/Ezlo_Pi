#ifndef __EZLOPI_UTIL_H__
#define __EZLOPI_UTIL_H__
...
#define CONFIG_EZPI_UTIL_TRACE_EN 1
    ...
    typedef void (*f_trace_func_t)(e_ezpi_trace_severity_t severity, const char *file, int line, uint64_t time, char *msg);
...
#else // (0 == CONFIG_EZPI_UTIL_TRACE_EN)
...
#endif // (1 == CONFIG_EZPI_UTIL_TRACE_EN)

#ifdef __cplusplus
}
#endif

#endif // __EZLOPI_UTIL_H__